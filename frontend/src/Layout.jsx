...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0c] transition-colors duration-300">
      ...
      {/* Main Content */}
      <main className={`pt-14 lg:pt-0 ${currentPageName === "Chat" ? "pb-0" : "pb-20"} lg:pb-0 min-h-screen dark:text-slate-100 transition-all duration-300 ${sidebarOpen ? "lg:ml-64" : "lg:ml-20"}`}>
        <AnnouncementBanner />
        {children}
      </main>
