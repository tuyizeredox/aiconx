...
useEffect(() => {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white dark:bg-ink-800 rounded-[2.5rem] border border-slate-100 dark:border-ink-700 p-8 text-center shadow-2xl shadow-slate-200/50 dark:shadow-black/50">
        {status === 'verifying' && (
          <div className="py-12">
            ...
            <p className="text-slate-500 dark:text-ink-400 font-medium">{t("payment.verifyingDesc")}</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="py-8">
            ...
            <p className="text-slate-500 dark:text-ink-400 font-medium mb-8">{t("payment.successDesc")}</p>
            <div className="grid gap-3">
              ...
              <Button asChild variant="outline" className="h-12 rounded-xl font-bold w-full border-slate-200 dark:border-ink-700">
        ...
        {status === 'error' && (
          <div className="py-8">
            ...
            <p className="text-slate-500 dark:text-ink-400 font-medium mb-8">{t("payment.failedDesc")}</p>
            <Button asChild variant="outline" className="h-12 rounded-xl font-bold w-full border-slate-200 dark:border-ink-700">
