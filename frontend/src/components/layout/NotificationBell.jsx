          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-slate-700">
              ...
              <div className="flex items-center gap-1">
                ...
                <button onClick={() => setOpen(false)} className="ml-2 p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg">
                ...
                notifications.map(notif => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-start gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-left border-b border-slate-50 dark:border-slate-700/50 last:border-0 ${!notif.is_read ? "bg-orange-50/40 dark:bg-orange-950/40" : ""}`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {notif.body && <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-2">{notif.body}</p>}
