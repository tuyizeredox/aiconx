      ...
      <button
        ...
        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all cursor-pointer active:scale-95 ${
          isOpen
            ...
            : "text-slate-400 dark:text-ink-400 hover:bg-slate-200 dark:hover:bg-ink-600 hover:text-slate-600"
        }`}
        title="Emoji Picker"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 bottom-full mb-2 z-[200] w-72 bg-white dark:bg-ink-800 rounded-2xl border border-slate-200 dark:border-ink-700 shadow-2xl overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-orange-50 to-pink-50 dark:from-orange-900/20 dark:to-pink-900/20 border-b border-slate-100 dark:border-ink-700">
              <span className="text-xs font-semibold text-slate-600 dark:text-ink-300">Emoji Picker</span>
              <button
                type="button"
                onClick={() => setIsOpen(false)}
                className="p-1 rounded-lg hover:bg-slate-200 dark:hover:bg-ink-700 transition-colors"
              >
            ...
            {/* Category tabs */}
            <div className="flex items-center gap-0.5 px-2 pt-2 pb-1 border-b border-slate-100 dark:border-ink-700 overflow-x-auto scrollbar-none">
            ...
            {/* Footer */}
            <div className="px-3 py-1.5 bg-slate-50 dark:bg-ink-700/50 border-t border-slate-100 dark:border-ink-700">
