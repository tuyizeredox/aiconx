...
export default function ReelsPlayer({ queue = [], startIndex = 0, startMediaIndex, currentUser, onClose }) {
  ...
  // Same rule as the feed: a phone gets the thread as a sheet over the video,
  // a desktop gets the post and its comments side by side. The video keeps
  // playing under the sheet — not losing the thing you are watching is the
