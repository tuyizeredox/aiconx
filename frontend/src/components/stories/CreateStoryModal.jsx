        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex gap-2 p-1 bg-slate-100 dark:bg-slate-700 rounded-xl">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-medium transition-colors ${type === "text" ? "bg-white dark:bg-slate-800 shadow-sm text-slate-900 dark:text-white" : "text-slate-500 dark:text-slate-400"}`}
            >
          ...
          <textarea
            ...
            rows={2}
            className="w-full text-sm text-slate-700 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 rounded-xl px-3 py-2.5 outline-none focus:border-orange-300 resize-none"
          />
