  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-sm rounded-2xl">
        ...
        {/* Banner */}
        <div className="relative h-24 rounded-xl overflow-hidden mb-2 bg-slate-100 dark:bg-slate-800 group">
          {bannerUrl ? (
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            />
            <p className="text-right text-[10px] text-slate-400 dark:text-slate-500">{bio.length}/160</p>
          </div>
        </div>
